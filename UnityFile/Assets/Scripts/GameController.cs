...
public class GameController : MonoBehaviour
{
    ...
    void SpawnEnemy()
    {
        Instantiate(enemies[Random.Range(0, enemies.Length)], spawnPosition.transform.position, Quaternion.Euler(0, 0, -90));//Randomly select number 0,1,2,3 representing enemies
